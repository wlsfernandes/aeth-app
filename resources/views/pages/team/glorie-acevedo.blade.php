        ...
        <div class="team-details-content">
            <div class="row clearfix">
                <div class="col-lg-3 col-md-12 col-sm-12 image-column">
                    <figure class="image-box"><img src="assets/images/team/glorie.jpg" alt=""></figure>
                </div>
                <div class="col-lg-9 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        ...
                        <ul class="info-list clearfix">
                            <li><span>Email:</span> <a href="mailto:gacevedorosa@aeth.org">gacevedorosa@aeth.org</a></li>
                        </ul>
                    </div>
                </div>
            </div>
