            ...
            <div class="team-details-content">
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-12 col-sm-12 image-column">
                        <figure class="image-box"><img src="assets/images/resource/Guesnerth Perea.jpg" alt=""></figure>
                    </div>
                    <div class="col-lg-9 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <h2>Guesnerth Perea</h2>
                            <p><b>@lang('ls25.speaker_title_6')</b></p>
                            <p>@lang('ls25.speaker_desc_6')</p>
