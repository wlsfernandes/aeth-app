                    ...
                    <div class="image-flip">
                        <div class="mainflip flip-0">
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <p><img class=" img-fluid" src="assets/images/logo/utla.png" alt="card image"></p>
                                        <h4 class="card-title" style="margin-top:30px;"> UTLA Universidad de Teología Los
                                            Ángeles</h4>
                                        <p class="card-text"> drtorrespastor@gmail.com</p>
                                        <p><a href="https://www.myabtc.org/cursos" target="blank"
                                                class="btn btn-primary btn-sm"
                                                style="background-color: #4a235a;border-color:#4a235a"><i
                                                    class="fa fa-plus"></i></a></p>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <p style="margin-top:15px"><i class="bi bi-globe"></i> <a
                                                    href="https://www.myabtc.org/cursos"
                                                    target="blank">https://www.myabtc.org/cursos</a></b>
                                            </p>
                                            <p style="margin-top:15px"><i class="bi bi-telephone"></i> (626) 584-5583</p>
                                            <p style="margin-top:15px"><i class="bi bi-geo-alt"></i> 460 Ford Pl. 3rd.
                                                Floor, Pasadena, CA 91101</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="backside">
                                <div class="card">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <p style="margin-top:15px"><i class="bi bi-globe"></i> <a
                                                    href="https://nazarene.org/es/nazarenosuscan/ente-online"
                                                    target="blank">https://nazarene.org/es/nazarenosuscan/ente-online</a></b>
                                            </p>
                                            <p style="margin-top:15px"><i class="bi bi-telephone"></i> (913) 577.0500</p>
                                            <p style="margin-top:15px"><i class="bi bi-geo-alt"></i> 17001 Prairie Star
                                                Parkway Lenexa, KS, USA 66220</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
