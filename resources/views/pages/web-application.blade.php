        ...
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary">
                ...
                <p class="card-title-desc" style="margin-top: 50px;">
                    ...
                    institutes / ministry formation programs.
                </p>
                <p class="card-title-desc">
                    The general purpose of this form is to collect the basic general information about the Bible
                    institute / ministry formation program to help AETH determine if your Bible institute / ministry
                    formation program is eligible and if it meets or not the minimal requirements for grant award. If
                    additional information is needed for further consideration, we may communicate and ask that you
                    expand on your proposal. This is an opportunity to tell us about your organization, the project that
                    you have in mind and the amount of support you will need to accomplish the project successfully. If
                    you believe that your Bible institute / ministry formation program meets the criteria of this grant,
                    we recommend that you continue reading the information included in this application.
                </p>
                <p class="card-title-desc">
                    We look forward to receiving your program’s application and discovering the ways we will support the
                    life of your institution and the communities served. It is our mission to continue promoting
                ...
                <p class="card-title-desc" style="margin-top: 30px;">AETH-Garrett Grant Advisory Council (GAC)</p>
                <small style="margin-top: 75px;"><i>We use the term “Bible institute” generically to refer to the
                        variety
                        of programs that have as primary goal the theological formation of congregations’ pastors and
                        leaders, and that use academic requisites of admission different to those established by
                        accredited
                        theological institutions to function as seminaries and theological schools.</i></small>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary">
                <h5 class="my-0 text-primary">
                    <i class="uil uil-paperclip me-3"></i> Capacity Building for Bible Institutes
                </h5>
                <p class="card-title-desc" style="margin-top: 20px;">
                    ...
                    this grant, we encourage you to access the provided files for complete information.
                </p>

                <h5 class="card-title text-end font-size-20" style="margin-top: 20px;">
                    <a href="https://gonzalezcenter.s3.us-east-2.amazonaws.com/CapacityBuilding/Applicants/Capacity+Building+for+Bible+Institutes+.pdf"
                        target="_blank">
            ...
            <div class="card-header bg-transparent border-primary">
                <h5 class="my-0 text-primary">
                    <i class="uil uil-paperclip me-3"></i> Subawarding Policies and Procedures Manual
                </h5>
                <p class="card-title-desc" style="margin-top: 20px;">
                    Click here to download the Subawarding Policies and Procedures Manual and review the comprehensive
                    guidelines.
                </p>
                <h5 class="card-title text-end font-size-20" style="margin-top: 20px;">
                    <a href="https://gonzalezcenter.s3.us-east-2.amazonaws.com/CapacityBuilding/Applicants/2025+Subawarding+Guidelines+for+Capacity+Building+.pdf"
                        target="_blank">
                        <img src="{{ asset('/assets/images/brands/pdf-icon.png') }}" alt="Guidelines"
                            style="width: 32px; height: 32px; vertical-align: middle;"> Download here
                    </a>
            ...
            <div class="card-header bg-transparent border-primary">
                <h5 class="my-0 text-primary">
                    <i class="uil uil-paperclip me-3"></i> Timeline For Participants
                </h5>
                <p class="card-title-desc" style="margin-top: 20px;">
                    Click here to download the 2025 Capacity Building Timeline Project and access the full project plan.
                </p>
                <h5 class="card-title text-end font-size-20" style="margin-top: 20px;">
                    <a href="https://gonzalezcenter.s3.us-east-2.amazonaws.com/CapacityBuilding/Applicants/2025+Timeline+for+Participants+Pilot+Year+FINAL.pdf"
                        target="_blank">
                        <img src="{{ asset('/assets/images/brands/pdf-icon.png') }}" alt="Guidelines"
                            style="width: 32px; height: 32px; vertical-align: middle;"> Download here
                    </a>
            ...
            <div class="card-header bg-transparent border-primary">
                <h5 class="my-0 text-primary">
                    <i class="uil uil-paperclip me-3"></i> Grant Evaluation Rubric
                </h5>
                <p class="card-title-desc" style="margin-top: 20px;">
                    Click here to download the Grant Evaluation Rubric Information document and review the detailed
                    evaluation criteria.
                </p>
                <h5 class="card-title text-end font-size-20" style="margin-top: 20px;">
                    <a href="https://gonzalezcenter.s3.us-east-2.amazonaws.com/CapacityBuilding/Applicants/2025+Grant+Evaluation+Rubric.pdf"
                        target="_blank">
                        <img src="{{ asset('/assets/images/brands/pdf-icon.png') }}" alt="Guidelines"
                            style="width: 32px; height: 32px; vertical-align: middle;"> Download here
                    </a>
